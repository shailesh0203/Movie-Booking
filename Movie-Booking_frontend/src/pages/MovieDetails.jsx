...
function MovieDetails() {
  ...
  return show?(
    <div className='px-6 md:px-16 lg:px-40 ot-30 md:pt-50'>
...
{show.movie.release_date.split("-")[0]}
  ...
  <a href="#dateSelect" className='px-10 py-3 ext-sm bg-primary hover:bg-primary-dull transition rounded-md front-mediumcursor-pointer active:scale-95'>Buy Tickets</a>
